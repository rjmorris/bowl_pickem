...
data picks;
    ...
    else if matchup eq "Illinois (6-6) vs. Louisiana Tech (8-5)" then winner = "";
    else if matchup eq "Rutgers (7-5) vs. North Carolina (6-6)" then winner = "";
    else if matchup eq "NC State (7-5) vs. UCF (9-3)" then winner = "";
    else if matchup eq "Virginia Tech (6-6) vs. Cincinnati (9-3)" then winner = " ";
    else if matchup eq "Duke (9-3) vs. Arizona State (9-3)" then winner = " ";
    else if matchup eq "Miami (Fla.) (6-6) vs. South Carolina (6-6)" then winner = " ";
    else if matchup eq "Boston College (7-5) vs. Penn State (6-6)" then winner = " ";
    else if matchup eq "Nebraska (9-3) vs. USC (8-4)" then winner = " ";
    else if matchup eq "West Virginia (7-5) vs. Texas A&M (7-5)" then winner = " ";
    else if matchup eq "Clemson (9-3) vs. Oklahoma (8-4)" then winner = " ";
    else if matchup eq "Texas (6-6) vs. Arkansas (6-6)" then winner = " ";
    else if matchup eq "Notre Dame (7-5) vs. LSU (8-4)" then winner = " ";
    else if matchup eq "Louisville (9-3) vs. Georgia (9-3)" then winner = " ";
    else if matchup eq "Maryland (7-5) vs. Stanford (7-5)" then winner = " ";
    else if matchup eq "TCU (11-1) vs. Ole Miss (9-3)" then winner = " ";
    else if matchup eq "Arizona (10-3) vs. Boise State (11-2)" then winner = " ";
    else if matchup eq "Georgia Tech (10-3) vs. Mississippi State (10-2)" then winner = " ";

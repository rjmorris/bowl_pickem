...
data picks;
    ...
    else if matchup eq 'Wisconsin (10-3) vs. Auburn (8-4)' then winner = 'Wisconsin';
    else if matchup eq 'Minnesota (8-4) vs. Missouri (10-3)' then winner = 'Missouri';
    else if matchup eq 'Baylor (11-1) vs. Michigan State (10-2)' then winner = 'Michigan State';
    else if matchup eq 'No. 2 Oregon (12-1) vs. No. 3 Florida State (13-0)' then winner = 'Oregon';
    else if matchup eq 'No. 1 Alabama (12-1) vs. No. 4 Ohio State (12-1)' then winner = 'Ohio State';
    else if matchup eq 'Houston (7-5) vs. Pittsburgh (6-6)' then winner = 'Houston';
    else if matchup eq 'Iowa (7-5) vs. Tennessee (6-6)' then winner = 'Tennessee';
    ...
    else if matchup eq 'Semifinal winners' then winner = 'Ohio State';
